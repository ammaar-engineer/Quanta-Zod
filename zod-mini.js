...
export class oz_initiate {
    constructor(securityMiddleware, transformerMiddleware) {
        this.oz = (obj, setup_arr) => {
...
console.log(guard.oz({ username: '  AmmAAr Dev  ' }, [
...
console.log(guard.oz({ score: 6, tes: 'a' }, [
...
console.log(guard.oz({ email: '  AMMAAR@Gmail.COM  ' }, [
...
console.log(guard.oz({ username: 'am' }, [
...
console.log(guard.oz({ username: '  Ammaar  ', score: 6 }, [
    {
        username: { type: qz('string', 'Must string'), min: qz(3, 'Too short') },
